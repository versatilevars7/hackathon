...
from youtube_api_info import Youtube_api_info
...
class Youtube_stats:
    ...
    def dump(self):
        """Dumps channel and video data into single json file"""
...
channel_id = 'UCZlzWvmHe5Zq2R9p9AgbEdQ'
API_KEY = Youtube_api_info.API_KEY
